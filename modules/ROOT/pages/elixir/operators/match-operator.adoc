...
this value with 5, which may yield a different result.

For instance, if `x` already equals 5 and we attempt `x = 7`, Elixir will throw a
`MatchError`—it can't match 5 with 7:
