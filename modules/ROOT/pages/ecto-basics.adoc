...
very basics of Ecto in the Phoenix context.
...
<2> All hell breaks loose. As dramatic as this sounds it is often the better way because it will result in a 404 page in your application. It's easier to catch bugs and you can be sure not to display something wrong.
====
