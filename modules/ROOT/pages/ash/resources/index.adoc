...
IMPORTANT: In Ash 3.x, resources live inside a *domain*. The domain is a
context boundary for a set of related resources and a place to hang
shared functionality (code interfaces, policies, pub/sub).
