...
#App.Shop.Category<
  ...
  ...
>
iex(4)> orange = Product.create!(%{name: "Orange", price: 0.15, category_id: fruits.id}) <3>
#App.Shop.Product<
...
{:ok,
 #App.Shop.Product<
   ...
   ...
 >}
iex(6)> second_orange = Product.by_name!("Orange", load: [:category])
#App.Shop.Product<
  category: #App.Shop.Category<
    __meta__: #Ecto.Schema.Metadata<:loaded>,
    id: "91cb42d8-45c2-451d-8261-72ae4d94a3c6",
...
#App.Shop.Category<
  ...
  ...
>
iex(8)> second_orange.category.name
"Fruits"
```
