...
The easiest way to proceed is to create a fresh Ash app.
Feel free to copy and paste the following lines in your terminal
or do it step by step following xref:ash/relationships/index.adoc#ash-relationships-setup[relationship setup].
...
- `Product`
- `Tag`
- `ProductTag` (which will be the clue between them)
