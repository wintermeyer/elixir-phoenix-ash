...
NOTE: Ash will not use the these integer IDs but UUIDs. I use
integer in the example table because it's easier to read for humans.
...
We open the iex and create all the products with their tags.
