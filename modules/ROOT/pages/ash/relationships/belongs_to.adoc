...
<5> The default create/update actions need to accept the foreign key
for the relationship to be settable through the code interface.
...
NOTE: Ash 3.24+ inspects resources as plain `%Module{}` structs (the full
