...
Learning <<elixir/index.adoc, Elixir>>, <<phoenix/index.adoc, Phoenix>>
and <<ash/index.adoc, Ash>> is a steep climb. No sugar-coating. This
book aims to make that ascent less steep. It's a guide crafted for
beginners.
