...
image::images/game_ping_no_action_pong.png[http://localhost:4000/game/ping]
...
image::images/ping_game_controller.png[http://localhost:4000/game/ping]
...
image::images/hello-world-with-phoenix-logo.png[http://localhost:4000/game/ping]
