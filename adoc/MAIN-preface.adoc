...
* **This book is a step by step guide. We start at zero.** I present you a small
  bite size pieces of code and add some callouts with additional information at
  the bottom of it. Step by step. As few chicken-egg-problems as possible. You
  are expected to understand the basics of programming and HTML but other than
  that you don't have to have any knowledge of Phoenix or Elixir.
