...
image::images/liveview_counter.png[http://localhost:4000/counter]
...
image::images/liveview_airport_search.png[http://localhost:4000/search]
...
image::images/liveview_airport_search_autocomplete.png[http://localhost:4000/search]
